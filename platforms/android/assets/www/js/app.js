...
var NOODLIO_PAY_API_KEY         = "Qftx8JFYdrmshLS6RyJlDilz06mAp1hJfmHjsnyk9PpMu8GIyS";
...
// Please also connect your account on this address
// https://www.noodl.io/pay/connect/test
var STRIPE_ACCOUNT_ID           = "acct_18dad4H9m5FgV8Am";

// Set your Firebase url
var FBURL                       = 'https://fire-fapp.firebaseio.com/';
...
var COMPANY_NAME                = "Bells Branding, Inc"; // don't forget to change it as well in menu.html
var LIMITVALUE                  = 100000;
var LIMITVALUE_LATEST           =13; // show only the X latest given the sortMethod
...
.state('splash', {
  ...
  .state('discover1', {
    url: '/discover1',
    templateUrl: 'templates/discover/discover1.html',
    controller: 'AccountCtrl'
  })
  .state('discover2', {
    url: '/discover2',
    templateUrl: 'templates/discover/discover2.html',
    controller: 'AccountCtrl'
  })
  .state('discover3', {
    url: '/discover3',
    templateUrl: 'templates/discover/discover3.html',
    controller: 'AccountCtrl'
  })
  .state('discover4', {
    url: '/discover4',
    templateUrl: 'templates/discover/discover4.html',
    controller: 'AccountCtrl'
  })
  .state('discover5', {
    url: '/discover5',
    templateUrl: 'templates/discover/discover5.html',
    controller: 'AccountCtrl'
  })
    .state('app', {
    url: '/app',
